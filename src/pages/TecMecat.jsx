...
const TecMecat = () => {
  const facts = [
    { icon: <FiAward />, label: 'Título', value: 'Técnico Superior en Mecatrónica' },
  ...
  return (
    <div className="bg-slate-950 font-sans min-h-screen">
      ...
      <div className="relative h-64 md:h-80 overflow-hidden">
        <img src={mecatronica} alt="Tecnicatura en Mecatrónica" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-10 text-center px-4">
          ...
          >
            Tecnicatura en <span className="text-emerald-400">Mecatrónica</span>
          </motion.h1>
      ...
      <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-1 space-y-4">
            ...
            <a
              href="http://www.frt.utn.edu.ar/tecnicaturas/mecatronica/?s=454"
              target="_blank"
              rel="noreferrer"
          ...
          >
            <h2 className="text-xl font-bold text-emerald-400 mb-4">¿Qué es la Mecatrónica?</h2>
            <p className="text-slate-300 leading-relaxed text-sm">
              La ingeniería mecatrónica es una rama multidisciplinaria de la ingeniería que desarrolla dispositivos y tecnologías uniendo sistemas, electrónica, mecánica y control, con el uso combinado de la robótica, la ingeniería electrónica y las ciencias de la computación.
            </p>
            <p className="text-slate-300 leading-relaxed text-sm mt-4">
              La mecatrónica busca crear maquinaria más compleja e inteligente para facilitar las actividades humanas mediante sistemas de control aplicados a la industria, robótica y automatización, integrando disciplinas de alta demanda en el mercado laboral moderno.
            </p>
          </motion.div>
        </div>
      </div>
