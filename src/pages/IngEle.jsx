...
const IngEle = () => {
  const facts = [
    { icon: <FiAward />, label: 'Título', value: 'Ingeniería Electrónica' },
  ...
  return (
    <div className="bg-slate-950 font-sans min-h-screen">
      ...
      <div className="relative h-64 md:h-80 overflow-hidden">
        <img src={electronica} alt="Ingeniería Electrónica" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-10 text-center px-4">
          ...
          >
            Ingeniería <span className="text-emerald-400">Electrónica</span>
          </motion.h1>
      ...
      <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            <a
              href="http://www.frt.utn.edu.ar/tecnoweb/imagenes/file/electronica/plan%20nuevo/PlanEstudios%202012anexoI.xls"
              target="_blank"
              rel="noreferrer"
            ...
            >
              <FiExternalLink /> Descargar Plan de Estudios
            </a>
          </div>
          ...
          >
            <h2 className="text-xl font-bold text-emerald-400 mb-4">¿Qué es la Ingeniería Electrónica?</h2>
            <p className="text-slate-300 leading-relaxed text-sm">
              La carrera prepara profesionales con una sólida formación científica y tecnológica capacitados para planear, diseñar, fabricar, mantener y manejar sistemas, equipos y componentes electrónicos con creatividad y espíritu crítico.
            </p>
            <p className="text-slate-300 leading-relaxed text-sm mt-4">
              Los egresados pueden estudiar, construir, operar, reparar e inspeccionar sistemas de comunicaciones, procesamiento electrónico de datos (hardware y software), y son capaces de proyectar y dirigir sistemas de enlace de comunicaciones, automatización y señales electromagnéticas en todas las frecuencias y potencias.
            </p>
          </motion.div>
        </div>
      </div>
